...
| --- | --- | --- | --- |
| 00 | [Business plan](00-business-plan.md) | What are we building, for whom, why, at what cost and risk? | ✅ Approved |
| 01 | [Product spec — Part 1](01-product-spec.md) | The map and voting, interaction by interaction | ✅ Approved |
| 02 | [Technology stack](02-tech-stack.md) | Which tools we build with, and why each one | ✅ Approved |
